...
class FastSpeech2Brain(sb.Brain):
    ...
    def run_inference(self):
        ...
        _, postnet_mel_out, _, _, _, _, _, predict_mel_lens =  self.hparams.model(tokens)
        ...
        _, postnet_mel_out_spn_pred, _, _, _, _, _, predict_mel_lens_spn_pred =  self.hparams.model(tokens_with_spn_tensor)
