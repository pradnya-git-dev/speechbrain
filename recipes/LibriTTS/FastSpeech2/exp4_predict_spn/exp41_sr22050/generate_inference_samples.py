...
fastspeech2 = FastSpeech2.from_hparams(source="/content/drive/MyDrive/mstts_saved_models/FastSpeech2/exp4_predict_spn/exp41_sr22050_e100",
                                     hparams_file="/content/speechbrain/recipes/LibriTTS/FastSpeech2/exp4_predict_spn/exp41_sr22050/fs2_inference_hparams.yaml")
...
torchaudio.save(os.path.join("/content", "random_1.wav"),waveforms.squeeze(1), 22050)
