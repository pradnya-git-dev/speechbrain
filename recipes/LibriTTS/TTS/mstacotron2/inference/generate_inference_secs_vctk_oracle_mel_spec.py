...
hifi_gan = HIFIGAN.from_hparams(source="/content/drive/MyDrive/2023/concordia/mstts_experiments/paper/saved_models/exp8_vocoder/exp80_hifigan_vctk_sr16000",
                                run_opts={"device": DEVICE})
...
for spk_dir in tqdm(glob.glob(f"{DATA_DIR}/*/*/*", recursive=True)):
    ...
    for tts_gt_wav in tqdm(tts_gt_wavs):
      ...
      torchaudio.save(synthesized_audio_path, waveform_ms.squeeze(1).cpu(), VOCODER_SAMPLE_RATE)
