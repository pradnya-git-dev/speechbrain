...
tacotron2_ms = Tacotron2MS.from_hparams(source="/content/drive/MyDrive/tacotron2/exp11_t_dec_gaw_75_resampled_16",
                                        hparams_file="/content/speechbrain/recipes/LibriTTS/exp10_t_xvector_16/inf_hparams.yaml",
                                        run_opts={"device": DEVICE})

hifi_gan = HIFIGAN.from_hparams(source="/content/drive/MyDrive/hifigan/ljspeech_resampled_16",
                                hparams_file="/content/speechbrain/recipes/LibriTTS/exp10_t_xvector_16/hifigan_inf_hparams.yaml",
                                run_opts={"device": DEVICE})
extension = [".wav"]
...
for wav_file in wav_list:
  ...
  synthesized_audio_path = os.path.join("/", *path_parts[:-1], uttid + "_synthesized_xvector_epoch54.wav")
