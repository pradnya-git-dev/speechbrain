...
TB_LOG_DIR = "/content/speechbrain/recipes/LibriTTS/TTS/exp9_random_speaker_sampling/exp92_two_stage/exp922_tacotron2_ecapa_frozen_z_sample/inf_tensorboard"
...
s_pre_spk_embs, s_z_spk_embs, s_post_spk_embs = [], [], []
s_pre_spk_embs_labels, s_z_spk_embs_labels, s_post_spk_embs_labels = [], [], []
...
with open(COS_SIM_SCORES_FILE, "w+") as cs_f:
  ...
  for wav_file in wav_list:
    ...
    mel_output_ms, mel_length_ms, alignment_ms, z_spk_embs = tacotron2_ms.encode_text(original_text, spk_emb)
