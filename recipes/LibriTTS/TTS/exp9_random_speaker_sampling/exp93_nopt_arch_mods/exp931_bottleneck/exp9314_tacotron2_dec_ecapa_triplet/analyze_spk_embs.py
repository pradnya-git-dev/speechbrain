...
TB_LOG_DIR = "/content/speechbrain/recipes/LibriTTS/TTS/exp9_random_speaker_sampling/exp93_nopt_arch_mods/exp931_bottleneck/exp9314_tacotron2_dec_ecapa_triplet/exp9314_debud_e250_inf_tensorboard"
...
tacotron2_ms = MSTacotron2.from_hparams(source="/content/drive/MyDrive/mstts_saved_models/TTS/exp9_random_speaker_sampling/exp93/exp9314_debug_e250",
                                        hparams_file="/content/speechbrain/recipes/LibriTTS/TTS/exp9_random_speaker_sampling/exp93_nopt_arch_mods/exp931_bottleneck/exp9314_tacotron2_dec_ecapa_triplet/tacotron2_inf_hparams.yaml",
                                        run_opts={"device": DEVICE})
...
with open(COS_SIM_SCORES_FILE, "w+") as cs_f:
  ...
  for wav_file in wav_list:
    ...
    mel_outputs, mel_length_ms, alignment_ms, z_spk_embs, z_mean, mlp_out = tacotron2_ms.encode_batch(same_spk_diff_phrases_phonemes, spk_emb)
